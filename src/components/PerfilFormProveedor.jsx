...
export function PerfilFormProveedor() {
  ...
  const [email, setEmail] = useState("contacto@minibodegas.com");
    ...
    <div className="min-h-screen flex flex-col justify-between bg-white">
      <div>
        ...
        >
          <div className="flex flex-col items-center mb-6">
            <label htmlFor="imagen" className="cursor-pointer">
              <div className="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden mb-2">
                {imagen ? (
                  <img src={imagen} alt="Proveedor" className="w-full h-full object-cover" />
                ) : (
          ...
          <div className="mb-4">
            <label className="block text-[#2C3A61] font-semibold mb-2">Nombre empresa</label>
            <input
              type="text"
              value={nombreEmpresa}
